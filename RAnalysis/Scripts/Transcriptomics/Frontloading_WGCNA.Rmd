...
nrow(vstExp_ChallengeUP.long.meta.means) # 4680, 2778
length(unique(vstExp_ChallengeUP.long.meta.means$Airradians.TranscriptID)) # 780, 463
```
...
nrow(vstExp_ChallengeDOWN.long) # 29160, 18630
...
nrow(vstExp_ChallengeDOWN.long.meta.means) # 6480, 4140
length(unique(vstExp_ChallengeDOWN.long.meta.means$Airradians.TranscriptID)) # 1080, 690
```
...
write.csv(Frontloaded_AirradiansTranscriptIDs, 
          file = "Output/Transcriptomics/WGCNA/challenge/Frontloading/UPmoduleRED_Frontloaded.csv")
...
leveneTest(Frontload_AOV) #0.9094
Frontload_SRH <- scheirerRayHare(mean.vstExp~pCO2_history*MatchMismatch,data=Frontload_vst_levels)
#                              Df    Sum Sq       H p.value
# pCO2_history                  1   2207342 12.9081 0.00033
# MatchMismatch                 1      8025  0.0469 0.82849
# pCO2_history:MatchMismatch    1   1642904  9.6074 0.00194
...
Frontload_modDunn <-  dunnTest(mean.vstExp ~ IDvar,
              ...
              method="bh")
# Comparison
# lowbaseline - lowchange	      -2.3449126	1.903154e-02	2.854731e-02	*
# lowbaseline - severebaseline	-4.7322102	2.220882e-06	1.332529e-05	*
# lowchange - severebaseline	  -2.3872976	1.697275e-02	3.394549e-02  *	
# lowbaseline - severechange	  -2.6936627	7.067165e-03	2.120150e-02  *	
# lowchange - severechange	    -0.3487501	7.272770e-01	7.272770e-01 	
# severebaseline - severechange	 2.0385476	4.149520e-02	4.979424e-02  rounds u to 0.05, n.s.	
...
# Out put the plots 
# pdf("Output/Transcriptomics/WGCNA/challenge/Frontloading/UPmoduleRED_FrontloadingActivated.pdf", height=8, width =8)
...
write.csv(Activated_AirradiansTranscriptIDs, 
          file = "Output/Transcriptomics/WGCNA/challenge/Frontloading/UPmoduleRED_Activated.csv")
...
#                             Df  Sum Sq      H p.value
# pCO2_history                 1   46907 4.9711 0.02577
# MatchMismatch                1     576 0.0611 0.80482
# pCO2_history:MatchMismatch   1    3157 0.3346 0.56295
Activated_modKW <- kruskal.test(mean.vstExp~IDvar,data=Activated_vst_levels)
# Kruskal-Wallis chi-squared = 5.3668, df = 3, p-value = 0.1468
...
pdf("Output/Transcriptomics/WGCNA/challenge/Frontloading/UPmoduleRED_FrontloadedAcivated.pdf", height=8, width =8)
ggarrange(Frontloaded_plot_1.1, Frontloaded_MEAN.SE_1.1,
                        ...
                        # dplyr::filter(ResponseRatio  < 25) %>% 
                          dplyr::filter(ResponseRatio  < 1.05) %>% 
                                      ...
                                      labs(y= "Control ratio, under baseline pCO2", 
                                           ...
                                           title = "Costly activation criteria (shaded) - module green") + 
...
CostlyActivation_AirradiansTranscriptIDs <- merge((df_total_1.2 %>% 
                                             ...
                                             AirrdiansTranscript_Proteinnames_2, 
                                             by = c('Protein_name','Airradians.TranscriptID'))
nrow(CostlyActivation_AirradiansTranscriptIDs) # 324
# View(Frontloaded_AirradiansTranscriptIDs)
# write csv of dfrontloaded genes
write.csv(CostlyActivation_AirradiansTranscriptIDs, 
          file = "Output/Transcriptomics/WGCNA/challenge/Frontloading/DOWNmoduleGREEN_CostlyActivation.csv")
# truncate the vst Exp means (mean exp for each gene within pCO2 history * pCO2 exposure, N = 5 each)
...
# pCO2_history                  1    6.9   6.927  10.718 0.00109 **
# MatchMismatch                 1    1.0   1.006   1.557 0.21236   
# pCO2_history:MatchMismatch    1    1.0   1.041   1.610 0.20471   
# Residuals                  1244  804.0   0.646 
mod <- scheirerRayHare(mean.vstExp~pCO2_history*MatchMismatch,data=CostlyActivation_vst_levels)
#                              Df    Sum Sq       H  p.value
# pCO2_history                  1   2106918 16.2200 0.000056
# MatchMismatch                 1    335688  2.5843 0.107929
# pCO2_history:MatchMismatch    1    474318  3.6515 0.056018
# Residuals                  1244 159063388   
...
modDunn <-  dunnTest(mean.vstExp ~ IDvar,
              ...
              method="bh")
# lowbaseline - lowchange	0.2144826	8.301707e-01	0.8301707250	 
# lowbaseline - severebaseline	4.1990164	2.680769e-05	0.0001608461 *	
# lowchange - severebaseline	3.9845338	6.761274e-05	0.0002028382 *	
# lowbaseline - severechange	1.7110847	8.706547e-02	0.1305982052 	
# lowchange - severechange	1.4966021	1.344968e-01	0.1613961783	
# severebaseline - severechange	-2.4879317	1.284884e-02	0.0256976844	*
...
Threshold_AirradiansTranscriptIDs <- merge((df_total_1.2 %>% filter(Frontloaded_criteria == 'threshold likely')),
                                             AirrdiansTranscript_Proteinnames_2, 
                                             by = c('Protein_name','Airradians.TranscriptID'))
nrow(Threshold_AirradiansTranscriptIDs) # 259

# write csv of dfrontloaded genes
write.csv(Threshold_AirradiansTranscriptIDs, 
          file = "Output/Transcriptomics/WGCNA/challenge/Frontloading/DOWNmoduleGREEN_Threshold.csv")
...
#                              Df   Sum Sq       H p.value
# pCO2_history                  1  1493553 16.6826 0.00004
# MatchMismatch                 1    87886  0.9817 0.32179
# pCO2_history:MatchMismatch    1   106500  1.1896 0.27541
# Residuals                  1032 90973196 
...
pdf("Output/Transcriptomics/WGCNA/challenge/Frontloading/DOWNmoduleGREEN_CostlyActivationThreshold.pdf", height=8, width =8)
ggarrange(CostlyActivation_plot_1.2, CostlyActivation_MEAN.SE_1.2,
