...
rlogExp_LowvHigh.annot <- merge(rlogExp_LowvHigh, AirradiansIDs_Proteinnames, by = "Airradians_TranscriptID")

nrow(rlogExp_LowvHigh.annot) == nrow(rlogExp_LowvHigh)

rlogExp_LowvHigh.long              <- rlogExp_LowvHigh.annot %>% 
                                            pivot_longer(
...
rlogExp_LowvHigh.long.meta.means   <- rlogExp_LowvHigh.long.meta %>% 
                                            dplyr::select(c(rlogExp, pCO2_exposure, pCO2_history, 
